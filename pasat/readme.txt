...
Adds an assistive-technology QA results template and extends smoke coverage for rendered signup summary announcements and atomic activity-board refresh status.
...
Adds public accessibility hook audit automation, makes activity board refresh status atomic, and gives dynamically generated venue-map popup direction links venue-specific accessible names.
