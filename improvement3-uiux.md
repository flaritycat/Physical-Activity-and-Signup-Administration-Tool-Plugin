...
6. Add accessibility polish and responsive checks. Continued in `0.1.14`; contrast and public accessibility hook checks are automated and the first keyboard fixes are in place, remaining work is manual assistive-technology, cross-theme, and follow-up keyboard checks.
